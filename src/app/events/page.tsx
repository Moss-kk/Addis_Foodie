            ...
            <button
              ...
              className={`touch-target px-5 py-2.5 rounded-full text-xs font-bold transition-all cursor-pointer ${
                selectedStatus === status
                  ...
                  : 'bg-white text-zinc-700 border border-stone-200 hover:border-[#FF8C00]'
              }`}
            >
            ...
            >
              <div className="flex flex-col">
                ...
                <div className="p-6 sm:p-8 flex flex-col gap-4">
                  <h3 className="font-syne font-black text-xl sm:text-2xl text-[#111827] group-hover:text-[#E53935] transition-colors">
                    {event.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-1">
                    {event.offeringTags.map((h, i) => (
                      <span
                        key={i}
                        className="px-2.5 py-1 bg-stone-100 text-zinc-700 text-[10px] font-bold rounded-lg border border-stone-200"
                      >
                        🐂 {h}
                      </span>
                    ))}
              ...
              <div className="p-6 sm:p-8 pt-0 flex items-center justify-between border-t border-stone-200 gap-3">
                <a
                  href={`tel:${event.phones[0]?.replace(/-/g, '')}`}
                  className="text-xs font-mono font-bold text-zinc-600 hover:text-[#E53935] transition-colors"
                >
                  📞 {event.phones[0]}
                </a>
