        ...
        <section className="bg-white p-8 sm:p-12 rounded-3xl border border-zinc-200 shadow-xs flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-sm text-zinc-600 font-medium leading-relaxed">
              Addis Ababa is a vibrant, rapidly evolving culinary hub where centuries-old fasting stews meet modern espresso culture and gourmet burgers. **Addis Foodies** was established to document, review, and celebrate this incredible food scene.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-zinc-100">
            <div className="bg-zinc-50 p-6 rounded-2xl border border-zinc-200 flex flex-col gap-2">
              <span className="text-3xl">🏆</span>
              <h3 className="font-syne font-bold text-base text-[#111827]">100% Curated & Author-Verified</h3>
              <p className="text-xs text-zinc-500 font-medium leading-relaxed">Every review is authored strictly by our editorial team. No user spam or star manipulation.</p>
            </div>

            <div className="bg-zinc-50 p-6 rounded-2xl border border-zinc-200 flex flex-col gap-2">
              <span className="text-3xl">💵</span>
              <h3 className="font-syne font-bold text-base text-[#111827]">Itemized Price Transparency</h3>
              <p className="text-xs text-zinc-500 font-medium leading-relaxed">We compile and verify dish pricing in ETB so local foodies have total clarity before visiting.</p>
            </div>

            <div className="bg-zinc-50 p-6 rounded-2xl border border-zinc-200 flex flex-col gap-2">
              <span className="text-3xl">📱</span>
              <h3 className="font-syne font-bold text-base text-[#111827]">Direct Social Flywheel</h3>
              <p className="text-xs text-zinc-500 font-medium leading-relaxed">Deep links to our original Instagram posts and Telegram updates for authentic multi-channel proof.</p>
            </div>
          </div>
          ...
          <div className="border-t border-zinc-100 pt-6 flex flex-wrap items-center gap-4">
            <Link
              href="/collaborate"
              className="touch-target bg-[#A81D1D] hover:bg-[#8B1717] text-white font-extrabold text-xs py-3 px-6 rounded-full transition-all shadow-md cursor-pointer"
            >
