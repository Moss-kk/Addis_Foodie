    ...
    <div className="flex flex-col min-h-screen bg-[#FAF8F5] dark:bg-[#120907] text-zinc-900 dark:text-[#FFF8F6] transition-colors duration-300 pb-16 sm:pb-0 max-w-full overflow-x-hidden">
      ...
      <main className="flex-1 site-container py-8 sm:py-12 flex flex-col gap-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-[#161E2E] p-6 sm:p-10 rounded-3xl border border-stone-200 dark:border-stone-800 shadow-xs flex flex-col gap-6">
            <div>
              <h2 className="font-display font-black text-2xl text-zinc-950 dark:text-white">
                Send Us a Message
              </h2>
            ...
            {submitted ? (
              <div className="bg-emerald-50 dark:bg-emerald-950/80 border border-emerald-200 dark:border-emerald-500/60 p-6 rounded-2xl text-center flex flex-col items-center gap-3">
                <CheckCircle className="w-10 h-10 text-emerald-600 dark:text-emerald-400" />
                <h3 className="font-display font-black text-lg text-emerald-950 dark:text-white">Message Sent Successfully!</h3>
                <p className="text-xs text-emerald-800 dark:text-emerald-200 font-medium max-w-md">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono font-bold uppercase text-stone-700 dark:text-stone-300">Full Name *</label>
                    <input
                      type="text"
                      required
                      value={formData.name}
                      ...
                      className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-xs sm:text-sm text-zinc-950 dark:text-white focus:outline-none focus:border-[#E53935] font-medium"
                    />
                  </div>

                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono font-bold uppercase text-stone-700 dark:text-stone-300">Email Address *</label>
                    <input
                      type="email"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono font-bold uppercase text-stone-700 dark:text-stone-300">Phone Number</label>
                    <input
                      type="tel"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono font-bold uppercase text-stone-700 dark:text-stone-300">Topic</label>
                    <select
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-mono font-bold uppercase text-stone-700 dark:text-stone-300">Message *</label>
                  <textarea
                    required
                    rows={5}
                    ...
                    className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-4 text-xs sm:text-sm text-zinc-950 dark:text-white focus:outline-none focus:border-[#E53935] font-medium"
                  />
                </div>
