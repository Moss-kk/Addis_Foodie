  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FAF8F5] dark:bg-[#120907] text-zinc-900 dark:text-[#FFF8F6] transition-colors duration-300 pb-16 sm:pb-0 max-w-full overflow-x-hidden">
      ...
      <main className="flex-1 site-container py-8 sm:py-12 flex flex-col gap-8">
        ...
        {/* Filters Bar */}
        <div className="flex flex-wrap items-center gap-3 bg-white dark:bg-[#1A100C] p-4 rounded-2xl border border-stone-200 dark:border-stone-800 shadow-xs">
          <span className="text-xs font-mono font-bold text-[#E53935] flex items-center gap-1">
          ...
          <div className="relative z-10 bg-[#111827]/95 backdrop-blur-xl border border-white/10 p-5 rounded-2xl text-white flex items-center justify-between gap-4 shadow-2xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="touch-target px-4 py-2.5 rounded-xl bg-[#E53935] hover:bg-[#B71C1C] text-white text-xs font-bold transition-colors flex items-center gap-1.5"
              >
                <span>Navigate</span>
