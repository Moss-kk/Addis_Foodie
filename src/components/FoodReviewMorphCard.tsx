  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 w-full overflow-hidden bg-stone-900">
        ...
        {/* Rating Overlay */}
        <div className="absolute top-2.5 left-2.5 bg-[#1A1C1E]/90 backdrop-blur-md px-2.5 py-1 rounded-md text-xs font-mono font-bold text-white border border-white/10 flex items-center gap-1">
        ...
        {/* Heritage Watermark Stamp */}
        <div className="absolute bottom-2 left-2.5 bg-[#1A1C1E]/80 backdrop-blur-xs px-2 py-0.5 rounded-sm border border-white/10 flex items-center gap-1.5 pointer-events-none">
      ...
      <div className="flex grow flex-row items-center justify-between p-3.5 gap-2 bg-[#1A1C1E]">
        ...
        <button
          ...
          className={`relative flex h-8 w-8 shrink-0 select-none appearance-none items-center justify-center rounded-xl border border-white/15 bg-stone-800/80 transition-colors ${
            saved 
              ? 'bg-[#B8422E]/20 text-[#B8422E] border-[#B8422E]/50' 
