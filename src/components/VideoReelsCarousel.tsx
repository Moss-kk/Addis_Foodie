      ...
      <section className="flex flex-col gap-5 py-4">
        <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-3">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-red-50 dark:bg-[#E53935]/20 text-[#E53935] flex items-center justify-center border border-red-200 dark:border-[#E53935]/40 shadow-xs">
              <Flame className="w-4 h-4 text-[#E53935] dark:text-[#FF8C00]" />
            </div>
            <div>
              <h2 className="font-syne font-black text-xl sm:text-2xl text-zinc-900 dark:text-[#FFF8F6] flex items-center gap-2">
          ...
          <span className="hidden sm:inline-flex text-[10px] font-mono font-bold text-[#E53935] dark:text-[#FF8C00] bg-red-50 dark:bg-[#FF8C00]/10 px-3 py-1 rounded-full border border-red-200 dark:border-[#FF8C00]/30 uppercase tracking-widest flex items-center gap-1">
        ...
        <div className="flex items-center gap-4 overflow-x-auto no-scrollbar scroll-smooth pb-3 snap-x snap-mandatory">
          {reels.map((reel) => (
            <div
              ...
              className="snap-start flex-shrink-0 w-44 sm:w-56 aspect-[9/16] relative rounded-2xl overflow-hidden flame-card cursor-pointer group shadow-lg transition-all duration-300 transform hover:scale-[1.03]"
            >
              {/* Thumbnail Image */}
              <Image
                src={reel.thumbnail}
              ...
              <div className="absolute top-3 left-3 bg-black/75 backdrop-blur-md px-2.5 py-1 rounded-full text-[11px] font-mono font-black text-amber-400 border border-amber-500/30 shadow-md">
                {reel.priceFormatted}
              </div>
              ...
              <div className="absolute bottom-0 inset-x-0 p-3.5 flex flex-col gap-1 z-10">
                ...
                <h3 className="font-syne font-bold text-xs sm:text-sm text-white line-clamp-1 group-hover:text-amber-300 transition-colors">
                  {reel.dishName}
                </h3>
              </div>
            </div>
