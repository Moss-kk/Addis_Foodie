  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#111827] via-[#8B1717] to-[#A81D1D] text-white py-3.5 px-5 sm:px-8 rounded-2xl shadow-xl border border-white/20 flex flex-col sm:flex-row items-center justify-between gap-4 relative overflow-hidden">
      ...
      <div className="flex items-center gap-3.5 z-10">
        <div className="w-10 h-10 rounded-2xl bg-[#10B981]/20 text-[#10B981] border border-[#10B981]/40 flex items-center justify-center text-xl flex-shrink-0">
          🥩
        </div>
        <div className="flex flex-col">
          <div className="flex items-center gap-2">
            <span className="bg-[#10B981] text-white text-[9px] font-black uppercase tracking-widest px-2.5 py-0.5 rounded-full shadow-xs animate-pulse">
              🚨 TODAY!! LIVE NOW
            </span>
