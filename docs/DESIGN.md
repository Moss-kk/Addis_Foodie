...
- `--bg-surface`: `#1A100C` (Warm Dark Card Surface with subtle border `rgba(229, 57, 53, 0.18)`)
...
## 2. Day & Night Theme Specifications
- **Night Flame Mode (`.dark`)**: Base Background `#120907`, Card Surface `#1A100C`, Text `#FFF8F6`.
- **Day Mode (Light)**: Base Background `#FAFAFA`, Card Surface `#FFFFFF`, Text `#111827`.
...
## 4. Layout Simplicity & Page Division
- **HOMEPAGE (`/`) MUST BE MINIMAL**: Hero Search + 9:16 Short-Form Video Reels Feed + Top 4 Curated Spots + AI Craving Finder.
...
- **EVENTS PAGE (`/events`)**: Kitfo Fest #5, rooftop takeovers, and festival tickets.
